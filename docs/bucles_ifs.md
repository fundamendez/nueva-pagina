...
<p align="center">
  <img src="/nueva-pagina/img/docs/if.png" alt="Diagrama de flujo if" width="250"></img>
</p>
...
Viéndolo gráficamente:
<p align="center">
  <img src="/nueva-pagina/img/docs/if-else.png" alt="Diagrama de flujo if-else" width="300"></img>
</p>
...
Viéndolo gráficamente:
<p align="center">
  <img src="/nueva-pagina/img/docs/if-else-if.png" alt="Diagrama de flujo if-else if-else" width="250"></img>
</p>
...
<p align="center">
  <img src="/nueva-pagina/img/docs/ejemplo_for.png" alt="Diagrama de flujo for" width="300"></img>
</p>
...
1. **Loop infinito:** es importante asegurarnos de que el loop en algún momento va a terminar, sino generaremos un loop infinito.
...
1. **Usar break o return:** en la cátedra consideramos una *mala práctica* el uso de `break` o `return` para cortar ciclos. Es importante que aprendamos a delimitarlos con condiciones (en el caso de while) o con cantidad de iteraciones (en el caso del for).

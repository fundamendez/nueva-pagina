...
#### ¿Qué pasa si el disparo del jugador cae afuera del tablero?

El programa debe volver a pedirle al jugador que ingrese un disparo válido, es decir, dentro del tablero.

#### ¿Las coordenadas del archivo de barcos están indexadas en 1 o en 0?

Las coordenadas del archivo de barcos están indexadas en 1, al igual que las coordenadas que el jugador ingresa para disparar. Esto significa que la posición (1,1) corresponde a la esquina superior izquierda del tablero, y la posición (10,10) corresponde a la esquina inferior derecha.

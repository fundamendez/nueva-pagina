...
<Tabs className="folder-tabs">
  <TabItem value="enunciado" label="Enunciado" default>
    ...
    Homero tendrá 5 antorchas mágicas para usar en cada nivel. Cuando la active, se revelará el camino que tenga Homero a una distancia manhattan 3. La antorcha dura únicamente un turno, es decir, se apagará una vez que Homero se mueva.
    ...
    * La antorcha dura únicamente un turno y se apaga una vez que homero se mueve. **Esto no fue mencionado en el video de presentación**.
    ...
    <p align="center">
      <img src="/img/fe_de_ratas.jpg" width="200" height="250"></img>
    </p>
  </TabItem>

  <TabItem value="pruebas" label="Pruebas">

...
Tendrá 200 de nafta y gastará 1 con cada movimiento. En caso de quedarse sin nafta antes de cumplir con el objetivo, se pierde el juego.
...
### 3.3 Autos
Además de Homero, habrá otros autos transitando por las calles. Al iniciar el juego, debe haber 6 autos circulando por la ciudad, con 100 de nafta. 
...
Cada auto tendrá un recorrido fijo en las calles. Este será dado por la cátedra para garantizar el correcto funcionamiento. Los autos sólo se mueven en la dirección del camino. Una vez que su recorrido termine (se salgan del mapa) deben ser eliminados.
...
Al pasar por una estación de servicio, al vehículo se le sumará 50 de nafta.
...
En cada esquina habrá una estación que lo hará parar por 5 movimientos. Es un monorriel que ocupa 4 posiciones (4 vagones) y se considera que llega a la estación cuando el primer vagón llega a la estación.

El monorriel comienza su recorrido en la estación que está en la esquina superior derecha (1;1), se mueve contra las agujas del reloj y su recorrido se da por terminado cuando llega a la misma estación de la que salió.
...
Al pasar un auto sobre una loma de burro, ésta reducirá en 1 su velocidad. Si la velocidad del auto ya es 1, no tendrá ningún efecto.
...
* Homero choca con otro vehiculo.
...
/*
 * Recibe un vector de coordenadas, su tope y un numero que debe estar entre 1 y 10.
 * Inicializa el vector con las coordenadas de un recorrido elegido segun el numero.
 */
void obtener_recorrido(coordenada_t recorrido[MAX_RECORRIDO], int *tope_recorrido, int numero_recorrido);
